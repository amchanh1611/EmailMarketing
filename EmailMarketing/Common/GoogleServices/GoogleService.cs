...
namespace EmailMarketing.Common.GoogleServices
{
    public interface IGoogleServices
    {
        ...
        Task<bool?> SendMailAsync(string from, string subject, string content,string refreshToken, string path, string fileName, params string[] to);
    }
    public class GoogleService : IGoogleServices
    {
        ...
        public async Task<bool?> SendMailAsync(string from, string subject, string content, string refreshToken, string path, string fileName, params string[] to)
        {
            ...
            MimeMessage mimeMessage = message.CreateMimeMessageAsync(path,fileName);
